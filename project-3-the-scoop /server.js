...
// upvote downvote other user articles
...
// setup, load, and connect database
function loadDatabase() {
  // grab yml database file if exists else log error
  try {
...
function saveDatabase() {
  // save yml database file if server running, else log error
  try {
